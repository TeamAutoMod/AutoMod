...
GREEN_TICK = "<:greenTick:751915988143833118>"
RED_TICK = "<:redTick:751916874522034239>"
WRENCH = "🔧"
SALUTE = "<:captaincanni:786968806027296810>"


def get_censor_pattern(guild_id):
    words = [x.strip().lower() for x in DBUtils.get(db.configs, "guildId", f"{guild_id}", "censored_words")]
