...
class DurationHolder:
    ...
    def to_seconds(self, ctx: discord.Interaction) -> None:
...
class DurationIdentifier(commands.Converter):
    async def convert(self, ctx: discord.Interaction, argument: Optional[str]) -> Union[str, Exception]:
        if argument is None:
            argument = "seconds"
...
class Duration(commands.Converter):
    async def convert(self, ctx: discord.Interaction, argument: Optional[str]) -> Union[DurationHolder, Exception]:
