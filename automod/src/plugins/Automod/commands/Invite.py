    ...
    if warns == "off":
        ...
        try:
            ...
            e = Embed(
                ...
                description=plugin.i18next.t(ctx.guild, "invalid_automod_feature_param", prefix=plugin.bot.get_guild_prefix(ctx.guild), command="invite <warns>", off_command="invite off")
            )
