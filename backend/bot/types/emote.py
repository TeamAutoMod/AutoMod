...
class Emote(commands.Converter):
    async def convert(self, ctx: discord.Interaction, argument: Optional[str]) -> Union[str, discord.Emoji, Exception]:
        try:
...
class ServerEmote(commands.Converter):
    async def convert(self, ctx: discord.Interaction, argument: str) -> Union[discord.Emoji, Exception]:
