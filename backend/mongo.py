...
class MongoCollection(Collection):
    def __init__(self, bot, database, name: str):
    ...
    def get_from_db(self, _id: DB_ID, key: str) -> Union[T, None]:
        return super().get(_id, key)
